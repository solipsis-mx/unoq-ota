...
> **Status (2026-09-05): historical.** Tasks 1–11 are implemented. The
> originally deferred host-payload path is in code and unit tests (not
> hardware-proven). AWS IoT Jobs is still not shipped. Do not re-run this
> plan. Resume from [CLAUDE.md](../../CLAUDE.md).
>
